...
public class Egg_Deform implements PlugInFilter {
...
double eggAR= 0.5+Math.random()*0.5;
double eggPoint=1;
...
for(int x=1; x<w-1; x++){
	...
	distance = Math.pow( (Math.pow(x-r,2)*1.5)+ Math.pow(y-(r),2)*1.5 ,0.5); // distance from centre
